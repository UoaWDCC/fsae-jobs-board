        ...
        <Grid.Col span={{ md: 3, xs: 12 }}>
          <Box ml={20} mt={20}>
            ...
            <Box pl={15} mt={10} className={classes.box}>
              {userData?.email && <Text size="xl">{userData.email}</Text>}
              {userData?.phone && <Text size="xl">{userData.phone}</Text>}
          ...
          <Box mx={20} mt={20}>
            ...
            <Box pl={15} mt={10} className={classes.box}>
              ...
              {userData?.description && (
                <>
                  {showMoreDescription ? (
                    <Text size="xl">{userData.description}</Text>
                  ) : (
                    <>
                      <Text size="xl">{userData.description.substring(0, 1200)}</Text>
                    </>
                  )}

...
/** ---------- Payload schema ---------- */
export const InputEmailPayload = z
  .object({
    ...
    // NOTE: Email fields validate by format, not character count
    // Therefore no min/maxCharacters support
...
export type InputEmailPayload = z.infer<typeof InputEmailPayload>;
